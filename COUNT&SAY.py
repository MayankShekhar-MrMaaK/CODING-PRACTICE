# -*- coding: utf-8 -*-
"""
Created on Tue Jun 16 15:17:26 2020
...
#  read off the digits, counting the number of digits in groups of
#  the same digit.
...
# we have two groups "2" and "1", "2" can be read as "12" which means 
